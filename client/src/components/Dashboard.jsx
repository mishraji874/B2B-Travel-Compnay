...
const Dashboard = () => {
    ...
    const company = {
        ...
        companyGSTNumber: 1234567890,
        companyEmail: 'john.doe@example.com',
        commpanyPhone: '+1234567890',
    ...
    return (
        <div className="dashboard">
            ...
            <div className="dashboard-details">
                ...
                <p><strong>Company GST Number: </strong> {company.companyGSTNumber}</p>
                <p><strong>Email:</strong> {company.companyEmail}</p>
                <p><strong>Phone:</strong> {company.commpanyPhone}</p>
                <p><strong>Address:</strong> {company.companyAddress}</p>
            </div>
            <div className="dashboard-content">
                <div className="card" onClick={goToProfileSettings}>
                    <h2>Profile</h2>
                    <p>Manage your profile and account settings.</p>
                </div>
                <div className="card" onClick={goToPreviousBookings}>
                    <h2>Bookings</h2>
                    <p>View and manage your bookings.</p>
                </div>
                <div className="card" onClick={goToContact}>
                    <h2>Support</h2>
                    <p>Contact support for help and assistance.</p>
                </div>
            </div>
        </div>
    );
